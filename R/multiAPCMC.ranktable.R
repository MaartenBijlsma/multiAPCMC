...
#' # this future data.
multiAPCMC.ranktable <- function(multiAPCMC.multifit.object,
  ...
  names(ranktable) <- c("linkfunction","noperiod","ref_period","ref_cohort")
    ...
    for(n in 1:length(vec.noperiod)) {
      ...
      for(p in 1:length(vec.refper)) {
        ...
        for(c in 1:length(vec.refcoh)) {
          ...
          ranktable$is.AIC[ranktable$linkfunction==lname &
          ...
          ranktable$oos.RMSE[ranktable$linkfunction==lname &
                               ranktable$noperiod==nname &
                               ranktable$ref_period==pname &
                               ranktable$ref_cohort==cname] <- multiAPCMC.multipredtest.object[[l]][[n]][[p]][[c]][1]

          ranktable$oos.MAE[ranktable$linkfunction==lname &
                              ranktable$noperiod==nname &
                              ranktable$ref_period==pname &
          ...
          ranktable$driftSE[ranktable$linkfunction==lname &
                              ranktable$noperiod==nname &
                              ranktable$ref_period==pname &
  ...
  ranktable$linkfunction <- as.character(ranktable$linkfunction)
